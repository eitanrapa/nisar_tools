...
With embedded urls: ( download the hardcoded list of files in the 'files =' block below)
    ...
    python ./download-all-2026-04-21_18-20-38.py

Download all files in a Metalink/CSV: (downloaded from ASF Vertex)

    python ./download-all-2026-04-21_18-20-38.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
...
class bulk_downloader:
    def __init__(self, download_dir, files):
        ...
        self.files = ["https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GSLC_BETA_V1/{0}/{1}.h5".format(file, file) for file in files]
...
def download_files(download_dir, files):
    ...
    if not isinstance(download_dir, str):
        raise ValueError("Download dir needs to be string")
